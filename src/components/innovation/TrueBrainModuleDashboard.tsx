      ...
      <div className="w-[180px] md:w-[240px] shrink-0 border-r border-[#1f2937] flex flex-col p-3.5 bg-[#080c14] relative justify-between h-full">
         ...
         <div className="flex flex-col gap-1 mt-2 overflow-y-auto no-scrollbar flex-1 pr-1 relative z-10">
            ...
            {moduleId === "sector-intel" ? (
              ...
              <>
                 <div
                   onClick={() => { setActiveSubtab("Insights"); scrollToContact(); }}
                 ...
                 <div
                   onClick={() => { setActiveSubtab("Engagements"); scrollToContact(); }}
                   className={`px-3 py-2.5 rounded-lg flex items-center gap-3 cursor-pointer transition-all ${
                 ...
                 <div
                   onClick={() => { setActiveSubtab("Invoices"); scrollToContact(); }}
                   className={`px-3 py-2.5 rounded-lg flex items-center gap-3 cursor-pointer transition-all ${
                 ...
                 <div
                   onClick={() => { setActiveSubtab("Workflows"); scrollToContact(); }}
                   className={`px-3 py-2.5 rounded-lg flex items-center gap-3 cursor-pointer transition-all ${
                 ...
                 <div
                   onClick={() => { setActiveSubtab("Team"); scrollToContact(); }}
                   className={`px-3 py-2.5 rounded-lg flex items-center gap-3 cursor-pointer transition-all ${
                     activeSubtab === "Team" 
                       ? "bg-[#1f2937]/30 border border-white/5 text-white shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]" 
                       : "text-white/40 hover:text-white/80"
